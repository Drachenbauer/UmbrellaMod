...
public class UmbrellaSeparateModels implements IModelGeometry<UmbrellaSeparateModels>
{
    private final BlockModel baseModel;
    private final ImmutableMap<ItemCameraTransforms.TransformType, BlockModel> perspectives;
    
    public UmbrellaSeparateModels(BlockModel baseModel, ImmutableMap<ItemCameraTransforms.TransformType, BlockModel> perspectives)
    {
    ...
    public static class Loader implements IModelLoader<UmbrellaSeparateModels>
    {
        ...
        @Override
        public UmbrellaSeparateModels read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
        {
            ...
            return new UmbrellaSeparateModels(baseModel, perspectives.build());
        }
    }
}